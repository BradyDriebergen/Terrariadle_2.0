...
import type { TerraTriviaCheckResult, TerraTriviaSession, TerraTriviaWinningData } from "$lib/types/terratrivia";
...
export async function checkTriviaQuestionGuess(userId: string, guess: string): Promise<TerraTriviaCheckResult> {
